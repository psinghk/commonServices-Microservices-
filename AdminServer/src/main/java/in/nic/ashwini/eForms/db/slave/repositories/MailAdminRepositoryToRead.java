...
import in.nic.ashwini.eForms.db.slave.entities.MailAdminFormsFromSlave;

@Repository
public interface MailAdminRepositoryToRead extends JpaRepository<MailAdminFormsFromSlave, Integer> {
