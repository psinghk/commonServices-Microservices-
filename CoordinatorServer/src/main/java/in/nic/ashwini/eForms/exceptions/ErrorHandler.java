...
import in.nic.ashwini.eForms.exceptions.custom.CustomException;
...
public class ErrorHandler {
	...
	ResponseEntity<?> exception(NoRecordFoundException e) {
		ErrorResponse error = new ErrorResponse();
		error.getErros().add(new Error(e.getAttribute(), e.getMessage()));
...
//	ResponseEntity<?> globalException(Exception e) {
//		ErrorResponse error = new ErrorResponse();
