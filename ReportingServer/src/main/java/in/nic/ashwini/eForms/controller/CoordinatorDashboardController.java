...
public class CoordinatorDashboardController {
	...
	@Autowired
	public CoordinatorDashboardController(FinalAuditTrackRepository finalAuditTrackRepository, UtilityService utilityService, DashBoardService dashBoardService, FinalAuditTrackRepositoryToRead finalAuditTrackRepositoryToRead) {
		super();
	...
	public Page<FinalAuditTrackFromSlave> completed(@RequestParam("email") @NotEmpty String email, SearchBean searchBean, Pageable pageable) {
		...
		return finalAuditTrackRepositoryToRead.findByStatusInAndCoordinatorEmailIn(status_list, emailList, sortedByIdDesc);
	}
	...
	public Page<FinalAuditTrackFromSlave> all(@RequestParam("email") @NotEmpty String email, SearchBean searchBean, Pageable pageable) {
		...
		return finalAuditTrackRepositoryToRead.findByCoordinatorEmailIn(emailList, sortedByIdDesc);
	}
	...
	public int countCompleted(@RequestParam("email") @NotEmpty String email) {
		List<String> status_list = Arrays.asList("completed");
		List<String> emailList = utilityService.aliases(email);
		return finalAuditTrackRepositoryToRead.countByStatusInAndCoordinatorEmailIn(status_list, emailList);
	}
	...
	public int countAll(@RequestParam("email") @NotEmpty String email) {
		List<String> emailList = utilityService.aliases(email);
		return finalAuditTrackRepositoryToRead.countByCoordinatorEmailIn(emailList);
	}
	...
	public Map<String,Set<String>> fetchFilter(@RequestParam("email") @NotEmpty String email){
		...
		List<String> emailList = utilityService.aliases(email);
		Set<String> services = dashBoardService.convertFormNamesForFilters(finalAuditTrackRepositoryToRead.findDistinctFormNamesForCo(emailList));
		Set<String> requestTypes = dashBoardService.setRequestTypes(finalAuditTrackRepositoryToRead.findDistinctStatusForCo(emailList));
