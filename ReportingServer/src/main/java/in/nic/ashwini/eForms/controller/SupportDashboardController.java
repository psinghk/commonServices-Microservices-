...
public class SupportDashboardController {
	...
	@Autowired
	public SupportDashboardController(FinalAuditTrackRepository finalAuditTrackRepository, UtilityService utilityService, DashBoardService dashBoardService, FinalAuditTrackRepositoryToRead finalAuditTrackRepositoryToRead) {
		super();
	...
	public Page<FinalAuditTrackFromSlave> completed(@RequestParam("email") @NotEmpty String email,@RequestParam("allowedForms") List<String> allowedForms, SearchBean searchBean, Pageable pageable) {
		Pageable sortedByIdDesc = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(),
				Sort.by("toDatetime").descending());
	...
	public Page<FinalAuditTrackFromSlave> rejected(@RequestParam("email") @NotEmpty String email, @RequestParam("allowedForms") List<String> allowedForms, SearchBean searchBean, Pageable pageable) {
		Pageable sortedByIdDesc = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(),
				Sort.by("toDatetime").descending());
	...
	public Page<FinalAuditTrackFromSlave> forwarded(@RequestParam("email") @NotEmpty String email, @RequestParam("allowedForms") List<String> allowedForms, SearchBean searchBean, Pageable pageable) {
		Pageable sortedByIdDesc = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(),
				Sort.by("toDatetime").descending());
	...
	@PostMapping("all")
	public Page<FinalAuditTrackFromSlave> all(@RequestParam("email") @NotEmpty String email, @RequestParam("allowedForms") List<String> allowedForms, SearchBean searchBean, Pageable pageable) {
		Pageable sortedByIdDesc = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(),
				Sort.by("toDatetime").descending());
		if (searchBean.getSearchKey() != null && !searchBean.getSearchKey().isEmpty()) {
			String searchKey = searchBean.getSearchKey();
