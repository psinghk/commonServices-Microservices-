...
public class Constants {
  ...
  //public static final String NIC_FIRST_COORD = "rsm@nic.in,prakash@nic.in,bkd@nic.in"; // to be uncommented in production
    ...
    //FOR FILTERS 
    public static final String EMAIL_REGISTRATION = "Email";
    public static final String VPN_REGISTRATION = "VPN";
    public static final String WIFI_REGISTRATION = "WiFi";
    public static final String LDAP_REGISTRATION = "LDAP";
    public static final String SMTP_REGISTRATION = "SMTP";
    public static final String DNS_REGISTRATION = "DNS";
    public static final String DISTRIBUTIONLIST_REGISTRATION = "Distribution List";
    public static final String SMS_REGISTRATION = "SMS";
    public static final String WEBCAST_REGISTRATION = "Webcast";
    public static final String CENTRALUTM_REGISTRATION = "Central UTM";
    public static final String IMAPPOP_REGISTRATION = "IMAP POP";
    public static final String UPDATEMOBILE_REGISTRATION = "Update Mobile";
    
    public static final String PENDING_REQUESTS = "Pending Requests";
    public static final String COMPLETED_REQUESTS = "Completed Requests";
    public static final String REJECTED_REQUESTS = "Rejected Requests";
    public static final String FORWARDED_REQUESTS = "Forwarded Requests";
    public static final String CANCELLED_REQUESTS = "Cancelled Requests";
